...
function openImageInLightbox(event) {
    ...
    if (currentLightbox) currentLightbox.close();
    currentLightbox = new (0, _simplelightboxDefault.default)(`<img width="1400" height="900" src="${largeImageUrl}" />`);
    currentLightbox.show();
}
document.addEventListener("keydown", (event)=>{
    if (event.key === "Escape" && currentLightbox) currentLightbox.close();
});
